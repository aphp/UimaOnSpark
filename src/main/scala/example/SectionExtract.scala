...
object SectionSegmenter {
  ...
  @transient 
  val tt = new org.apache.uima.dkpro.spark.SectionSegmenterPojo(Array(1,2,3), Array(2,2,2),Array("section1","section2","section3"))
  ...
  def main(args: Array[String]) {
    ...
    val fruit = List("ceci est un compte rendu.\nsection1\n contenu premiere section. section2\nconte\"nu seconde section. Avec la suite.", 
    ...
    val rdd = sc.parallelize(fruit, 8)
    rdd.map(string => {
    accum.add(1)
    tt.analyzeText(1234, 2, string)
